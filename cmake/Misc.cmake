...
# ---[ Solution folders
latte_option(USE_PROJECT_FOLDERS "IDE Solution folders" (MSVC_IDE OR CMAKE_GENERATOR MATCHES Xcode) )
...
if(UNIX OR APPLE)
  add_custom_target(symlink_to_build COMMAND "ln" "-sf" "${PROJECT_BINARY_DIR}" "${PROJECT_SOURCE_DIR}/build"
                                     COMMENT "Adding symlink: <latte_root>/build -> ${PROJECT_BINARY_DIR}" )
endif()

# ---[ Set debug postfix
set(Latte_DEBUG_POSTFIX "-d")

set(Latte_POSTFIX "")
if(CMAKE_BUILD_TYPE MATCHES "Debug")
  set(Latte_POSTFIX ${Latte_DEBUG_POSTFIX})
endif()
