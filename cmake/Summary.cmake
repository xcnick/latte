...
function(latte_extract_latte_version)
  ...
  # latte_parse_header(${Latte_INCLUDE_DIR}/latte/version.hpp Latte_VERSION_LINES CAFFE_MAJOR CAFFE_MINOR CAFFE_PATCH)
  # set(Latte_VERSION "${CAFFE_MAJOR}.${CAFFE_MINOR}.${CAFFE_PATCH}" PARENT_SCOPE)
...
function(latte_print_configuration_summary)
  ...
  latte_status("  Version           :   ${CAFFE_TARGET_VERSION}")
